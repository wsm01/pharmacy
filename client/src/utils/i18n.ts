const translations = {
  English: {
    ...
    'camera_access_error': 'Camera access denied or not found.',
    'upload_instead': 'Upload an image instead',
    'confirm_scanned_item': 'Confirm Scanned Item',
    'finalize_scanned_sale': 'Finalize Scanned Sale',
    'how_many_units': 'How many units to sell?',
    'scanned_success': 'Medicine identified successfully!',
  ...
  French: {
    ...
    'barcode': 'Code-barres / Code QR',
    'scan_medicine': 'Scanner un Médicament',
    'camera_access_error': 'Accès caméra refusé ou non trouvé.',
    'upload_instead': 'Télécharger une image à la place',
    'confirm_scanned_item': 'Confirmer l\'article scanné',
    'finalize_scanned_sale': 'Finaliser la vente scannée',
    'how_many_units': 'Combien d\'unités à vendre ?',
    'scanned_success': 'Médicament identifié avec succès !',
    'stop_scanner': 'Arrêter la caméra',
    'start_scanner': 'Démarrer la caméra',
  ...
  Arabic: {
    ...
    'barcode': 'باركود / رمز QR',
    'scan_medicine': 'مسح الدواء',
    'camera_access_error': 'تم رفض الوصول إلى الكاميرا أو لم يتم العثور عليها.',
    'upload_instead': 'تحميل صورة بدلاً من ذلك',
    'confirm_scanned_item': 'تأكيد العنصر الممسوح',
    'finalize_scanned_sale': 'إتمام البيع الممسوح',
    'how_many_units': 'كم عدد الوحدات المراد بيعها؟',
    'scanned_success': 'تم التعرف على الدواء بنجاح!',
    'stop_scanner': 'إيقاف الكاميرا',
    'start_scanner': 'تشغيل الكاميرا',
